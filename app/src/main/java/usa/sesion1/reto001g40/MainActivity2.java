...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawable1 = res1.getDrawable(R.drawable.ceramoldeadora,getTheme());
        ...
        drawable2 = res2.getDrawable(R.drawable.keratina,getTheme());
        ...
        drawable3 = res3.getDrawable(R.drawable.tratamientoequino,getTheme());
